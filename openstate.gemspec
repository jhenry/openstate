...
Gem::Specification.new do |s|
  ...
  s.authors = ["Justin Henry"]
  s.date = %q{2010-11-03}
  s.description = %q{TODO: longer description of your gem}
  s.email = %q{justin.henry@gmail.com}
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.rdoc"
  ]
  s.files = [
    ...
    "VERSION",
    "lib/openstate.rb",
    "spec/openstate_spec.rb",
    "spec/spec_helper.rb"
  ]
  s.homepage = %q{http://github.com/jhenry/openstate}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{TODO: one-line summary of your gem}
  s.test_files = [
    "spec/bill_spec.rb",
    "spec/committee_spec.rb",
    "spec/legislator_spec.rb",
    "spec/openstate_spec.rb",
    "spec/spec_helper.rb",
    "spec/statemetadata_spec.rb"
  ]
